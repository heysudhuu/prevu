...
function FloatingElements() {
  ...
  return (
    <group ref={groupRef}>
      {/* 1. Main floating abstract paper / slate in top right background */}
      <Float speed={2} rotationIntensity={1.5} floatIntensity={1.5} position={[4, 2, -2]}>
      ...
      <Float speed={2.5} rotationIntensity={2} floatIntensity={2} position={[-4.5, 1.5, -4]}>
        <Octahedron args={[1.2]} material={accentMaterial} />
      </Float>

      <Float speed={1.8} rotationIntensity={1} floatIntensity={1.5} position={[-3, -3, -3]}>
        <Box args={[1.4, 1.4, 1.4]} material={secondaryMaterial} />
      </Float>

      {/* 3. Small orbiting glass spheres */}
      <Float speed={3} rotationIntensity={3} floatIntensity={2.5} position={[5, -2, -5]}>
        <Sphere args={[0.8, 32, 32]} material={glassMaterial} />
      </Float>

      <Float speed={1.2} rotationIntensity={1} floatIntensity={1} position={[-6, 0, -6]}>
